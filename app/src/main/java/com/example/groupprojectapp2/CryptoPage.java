 ...
 * Use the {@link CryptoPage#newInstance} factory method to
...
public class CryptoPage extends Fragment {
     ...
     * @return A new instance of fragment CryptoPage.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view.findViewById(R.id.btn_alert).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_cryptoPage_to_ratePage);
            }
        });
        return view;
    }
